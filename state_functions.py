...
class StateFunctions(object):
    ...
    def get_v(self):
        # get the 0th emg signal and constrain it to range 0 to 1
        ...
        # be default make the arm slowly move backwards, but when emg present - move forward
        v = np.array([emg0 * emg2, emg1 * emg2])
    ...
    def move(self):
        ...
        # • we have desired ee velocity that is mapped from the EMG signal
