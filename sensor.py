...
class SensorState(object):  # this class keeps track of sensor data
    ...
    def __init__(self, ticker_frequency):
        ...
        self.angular_velocity_1 = 0
        self.angular_velocity_2 = 0
        return
    ...
    def update(self):
        ...
        self.angular_velocity_1 = self.encoder_motor_1.get_angular_velocity(self.angle_motor_1,
                                                                            self.angle_motor_1_previous)
        self.angular_velocity_2 = self.encoder_motor_2.get_angular_velocity(self.angle_motor_1,
                                                                            self.angle_motor_1_previous)
        return
